  ...
  return {
    ...
    callback: function (e) {
      ...
      for (a = 0; a < d;) {
        ...
        A && (b += '<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to=' + h[a] + '" class="twitter_reply_icon"><i class="icon-reply"></i>&nbsp;</a><a href="https://twitter.com/intent/retweet?tweet_id=' + h[a] + '" class="twitter_retweet_icon"><i class="icon-retweet"></i>&nbsp;</a><a href="https://twitter.com/intent/favorite?tweet_id=' +
          h[a] + '" class="twitter_fav_icon"><i class="icon-star"></i>&nbsp;</a></p>');
        c.push(b);
        a++
      }
      if (null == w) {
...
// hashtags.
twitterFetcher.fetch('361607838595944451', 'twitter_update_list', 1, true, false, false, 'default', false);

function formatTweet (text) {
  var regex = /@([A-Za-z0-9_]+)/ig;
  var username = text.match(regex);
  text = text.replace(regex, "<a href='http://www.twitter.com/$1'>@$1</a>");
  return text;
};